...
window.Dom7 = (function () {
    ...
    function ajax(options) {
        ...
        function fireAjaxCallback(eventName, eventData, callbackName) {
            var a = arguments;
            if (eventName) {
                $$1(document).trigger(eventName, eventData);
            }
            if (callbackName) {
                // Global callback
                if (callbackName in globals) {
                    globals[callbackName](a[3], a[4], a[5], a[6]);
                }
                // Options callback
            ...
            if ((xhr.status >= 200 && xhr.status < 300) || xhr.status === 0) {
                ...
                if (options.dataType === 'json') {
                    try {
                        ...
                        fireAjaxCallback('ajaxSuccess ajax:success', {
                            xhr: xhr
    ...
    var Template7 = function Template7(template) {
        ...
        function compile(template, depth) {
            ...
            function getCompileFn(block, newDepth) {
                if (block.content) {
                    return compile(block.content, newDepth);
                }
                return function empty() {
                    return '';
                };
            ...
            function getCompileInverse(block, newDepth) {
                if (block.inverseContent) {
                    return compile(block.inverseContent, newDepth);
                }
                return function empty() {
                    return '';
                };
    ...
    window.Framework7 = function (params) {
        ...
        var Searchbar = function (container, params) {
            ...
            s.search = function (query, internal) {
                ...
                if (s.params.customSearch) {
                    s.triggerEvent('search searchbar:search', 'onSearch', {
                        query: query
                    });
                    return;
                }
        ...
        ************   Pages   ************
        ...
        app.pageInitCallback = function (view, params) {
            ...
            if (pageContainer.f7PageInitialized && ((view && view.params.domCache) || (!view && $(pageContainer).parents('.popup, .popover, .login-screen, .modal, .actions-modal, .picker-modal').length > 0))) {
                ...
                $(pageData.container).trigger('pageReinit page:reinit', {
                    page: pageData
                });
                return;
            }
            ...
            $(pageData.container).trigger('pageBeforeInit page:beforeinit', {
                page: pageData
            });
            ...
            $(pageData.container).trigger('pageInit page:init', {
                page: pageData
            });
        };
        app.pageRemoveCallback = function (view, pageContainer, position) {
            ...
            $(pageData.container).trigger('pageBeforeRemove page:beforeremove', {
                page: pageData
            });
            pageData = null;
        };
        app.pageBackCallback = function (callback, view, params) {
            ...
            if (callback === 'after') {
                ...
                $(pageContainer).trigger('pageAfterBack page:afterback', {
                    page: pageData
                });
            ...
            if (callback === 'before') {
                ...
                $(pageData.container).trigger('pageBack page:back', {
                    page: pageData
                });
            }
        };
        app.pageAnimCallback = function (callback, view, params) {
            ...
            if (callback === 'after') {
                ...
                $(pageData.container).trigger('pageAfterAnimation page:afteranimation', {
                    page: pageData
                });
            ...
            if (callback === 'before') {
                ...
                $(pageData.container).trigger('pageBeforeAnimation page:beforeanimation', {
                    page: pageData
                });
            }
        };
        ...
        app.initSwipePanels = function () {
            ...
            function handleTouchMove(e) {
                ...
                if (effect === 'reveal') {
                    ...
                    panel.trigger('panel:swipe', {
                        progress: Math.abs(translate / panelWidth)
                    });
        ...
        app.initSortable = function () {
            ...
            function handleTouchEnd(e) {
                ...
                if (insertAfter) {
                    ...
                    sortingEl.trigger('sort sortable:sort', {
                        startIndex: startIndex,
                        newIndex: sortingEl.index()
                    });
                }
                if (insertBefore) {
            ...
            if (openIn === 'popup') {
                ...
                if (reLayout) {
                    ...
                    picker.once('picker:close', function () {
                        ...
                        smartSelect.parents('.page-content').css({
                            paddingBottom: ''
                        });
                    });
        ...
        ************   Pull To Refresh   ************
        ...
        app.initPullToRefresh = function (pageContainer) {
            ...
            var touchId, isTouched, isMoved, touchesStart = {},
                ...
                useTranslate = false,
                startTranslate = 0,
                translate, scrollTop, wasScrolled, layer, triggerDistance, dynamicTriggerDistance, pullStarted;
        ...
        ************   Handle clicks and make them fast (on tap);   ************
        ...
        app.initClickEvents = function () {
            ...
            function handleClicks(e) {
                ...
                //sign up test
                var signupScreen;
                if (clicked.hasClass('open-signup-screen')) {
                    if (clickedData.signupScreen) {
                        signupScreen = clickedData.signupScreen;
                    } else signupScreen = '.signup-screen';
                    app.loginScreen(signupScreen);
                }
                if (clicked.hasClass('close-login-screen')) {
                    app.closeModal('.signup-screen.modal-in');
                }
                // Close Modal
        ...
        ************   Store and parse forms data   ************
        ...
        app.formToData = function (form) {
            ...
            form.trigger('formToJSON formToData form:todata', {
                formData: formData
            });
        ...
        app.formFromData = function (form, formData) {
            ...
            form.trigger('formFromJSON formFromData form:fromdata', {
                formData: formData
            });
        };
        ...
        app.initFormsStorage = function (pageContainer) {
            ...
            function storeForm() {
                ...
                form.trigger('store form:storedata', {
                    data: formJSON
                });
            }
        ...
        $(document).on('submit change', 'form.ajax-submit, form.ajax-submit-onchange', function (e) {
            ...
            var xhr = $.ajax({
                ...
                beforeSend: function (xhr) {
                    form.trigger('beforeSubmit form:beforesend', {
                        data: data,
                        xhr: xhr
                    });
                },
                error: function (xhr) {
                    form.trigger('submitError form:error', {
                        data: data,
                        xhr: xhr
                    });
                },
                success: function (data) {
                    form.trigger('submitted form:success', {
                        data: data,
                        xhr: xhr
                    });
                }
        ...
        app.initDataTable = function (table) {
            ...
            table.on('change', '.checkbox-cell input[type="checkbox"]', function (e) {
                ...
                if (headerCell.length > 0) {
                    ...
                    table.find('tbody tr td:nth-child(' + (columnIndex + 1) + ') input').prop('checked', checked).trigger('change', {
                        _sentByF7DataTable: true
                    });
                } else {
                    ...
                    if (!checked) {
                        ...
                        if (table.find('tbody .checkbox-cell:nth-child(' + (columnIndex + 1) + ') input[type="checkbox"]:checked').length === table.find('tbody tr').length) {
                            table.find('thead .checkbox-cell:nth-child(' + (columnIndex + 1) + ') input[type="checkbox"]').prop('checked', true).trigger('change', {
                                _sentByF7DataTable: true
                            });
                        }
                    }
